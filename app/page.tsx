...
// استعلام واحد بكلمات متجاورة كان بيرجّع نفس المقالات القديمة كل مرة (مافيش نشر كتير
// بالضبط بكل الكلمات دي مع بعض) — استعلام OR بينهم بيوسّع البحث لأخبار مالية مصرية أحدث
const NEWS_QUERY = '"البورصة المصرية" OR "بورصة مصر" OR "الاقتصاد المصري" OR EGX30';
